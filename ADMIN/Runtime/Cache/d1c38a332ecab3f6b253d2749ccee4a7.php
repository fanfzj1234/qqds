...
<div class="date">
<table width="95%"   style="margin-left:30px; font-size:12px;">
<tr>
<?php
for($i=0;$i<=30;++$i) { echo "<td>"; $time=time()-$i*24*3600; $date1=date('m',$time); $date2=date('d',$time); echo $date1."<br>".$date2; echo "</td> "; } ?>
</tr>
<tr>
</tr>
</table>
