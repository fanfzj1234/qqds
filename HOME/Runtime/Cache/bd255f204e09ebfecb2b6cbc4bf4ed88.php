  ...
  <div id="topbar">
    <div id="topnav">
      <ul>
	    ...
	    <li><a href="__APP__/Show/show_electric_activity">电商活动展示</a></li>
           </ul>
        </li>
        <li><a href="#">电子商务专业</a>
          <ul>
...
<div class="container">
 <a href="__APP__">首页</a>>>网站制作
<div id="info_main" class="wrapper col8">
    <div id="header"><h2><?php echo $activity_call['theme']; ?></h2></div>
    <div id="info_content">
     <?php
 echo $activity_call['content'] ?>
    </div>
    <div id="footer" style="margin-top:30px;"><div><?php echo $activity_call['datetime'] ?></div><div></div>
</div>
</div>
