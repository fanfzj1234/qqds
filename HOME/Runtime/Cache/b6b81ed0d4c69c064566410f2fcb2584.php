...
<div id="info_main" class="wrapper col8">
    <div id="header"><h2><?php echo $web_make['theme']; ?></h2></div>
    <div id="info_content">
     <?php
 echo $web_make['content'] ?>
    </div>
    <div id="footer" style="margin-top:30px;"><div><?php echo $web_make['publish_time'] ?></div><div></div>
</div>
</div>
