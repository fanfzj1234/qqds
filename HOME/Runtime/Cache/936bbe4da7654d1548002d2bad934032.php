...
<div class="container">
 <a href="__APP__">首页</a>>>大学生活展示
<div id="info_main" class="wrapper col8">
    <div id="header"><h2><?php echo $activity_show['theme']; ?></h2></div>
    <div id="info_content">
     <?php
 echo $activity_show['content'] ?>
    </div>
    <div id="footer" style="margin-top:30px;"><div><?php echo $activity_show['datetime'] ?></div><div></div>
</div>
</div>
