...
<div class="container">
<a href="__APP__">首页</a>>>电商活动展示列表
<div id="info_list_main">
<?php
 $count=count($electric_activity); if($count){ ?>
    <ul>
      <?php if(is_array($electric_activity)): foreach($electric_activity as $key=>$electric_activity): ?><li><a href="__APP__/Show/show_electric_activity?Id=<?php echo ($electric_activity["Id"]); ?>"><?php echo ($electric_activity["theme"]); ?></a>  
      <span><?php echo ($electric_activity["datetime"]); ?></span>
      </li>
