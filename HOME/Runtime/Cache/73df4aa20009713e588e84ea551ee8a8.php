...
<div class="container">
<a href="__APP__">首页</a>>>网站制作列表
<div id="info_list_main">
<?php
 $count=count($web_make); if($count){ ?>
    <ul>
      <?php if(is_array($web_make)): foreach($web_make as $key=>$web_make): ?><li><a href="__APP__/Show/show_web_make?Id=<?php echo ($web_make["Id"]); ?>"><?php echo ($web_make["theme"]); ?></a>  
      <span><?php echo ($web_make["publish_time"]); ?></span>
      </li>
