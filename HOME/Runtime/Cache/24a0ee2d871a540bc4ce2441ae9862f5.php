...
<div class="container">
<a href="__APP__">首页</a>>>活动召集列表
<div id="info_list_main">
<?php
 $count=count($activity_call); if($count){ ?>
    <ul>
      <?php if(is_array($activity_call)): foreach($activity_call as $key=>$activity_call): ?><li><a href="__APP__/Show/show_activity_call?Id=<?php echo ($activity_call["Id"]); ?>"><?php echo ($activity_call["theme"]); ?></a>  
      <span><?php echo ($activity_call["datetime"]); ?></span>
      </li>
