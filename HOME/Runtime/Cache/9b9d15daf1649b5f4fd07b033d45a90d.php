...
<div class="container">
   <a href="__APP__">首页</a>>>原创文学
  <div id="info_list_main">
    <ul>
      <?php if(is_array($origliterature)): foreach($origliterature as $key=>$origliterature): ?><li><a href="__APP__/Show/show_origliterature?Id=<?php echo ($origliterature["Id"]); ?>"><?php echo ($origliterature["Title"]); ?></a>  
      <span><?php echo ($origliterature["Time"]); ?></span>
      </li>
