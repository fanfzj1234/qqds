...
<div id="info_main" class="wrapper col8">
    <div id="header"><h2><?php echo $ds_homework['theme']; ?></h2></div>
    <div id="info_content">
     <?php
 echo $ds_homework['content'] ?>
    </div>
    <div id="footer" style="margin-top:30px;"><div><?php echo $ds_homework['datetime'] ?></div><div></div>
</div>
</div>
