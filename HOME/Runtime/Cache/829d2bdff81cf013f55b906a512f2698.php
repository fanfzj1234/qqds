...
<div class="container">
<a href="__APP__">首页</a>>>电子商务作业
<div id="info_list_main">
<?php
 $count=count($ds_homework); if($count){ ?>
    <ul>
      <?php if(is_array($ds_homework)): foreach($ds_homework as $key=>$ds_homework): ?><li><a href="__APP__/Show/show_ds_homework?Id=<?php echo ($ds_homework["Id"]); ?>"><?php echo ($ds_homework["theme"]); ?></a>  
      <span><?php echo ($ds_homework["datetime"]); ?></span>
      </li>
