...
<div class="container">
<a href="__APP__">首页</a>>>大学生活动展示列表
<div id="info_list_main">
<?php
 $count=count($activity_show); if($count){ ?>
    <ul>
      <?php if(is_array($activity_show)): foreach($activity_show as $key=>$activity_show): ?><li><a href="__APP__/Show/show_activity_show?Id=<?php echo ($activity_show["Id"]); ?>"><?php echo ($activity_show["theme"]); ?></a>  
      <span><?php echo ($activity_show["datetime"]); ?></span>
      </li>
