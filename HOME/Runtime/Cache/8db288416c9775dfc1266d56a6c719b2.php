...
<div class="container">
<a href="__APP__">首页</a>>>电子商务课程
<div id="info_list_main">
<?php
 $count=count($ds_class); if($count){ ?>
    <ul>
      <?php if(is_array($ds_class)): foreach($ds_class as $key=>$ds_class): ?><li><a href="__APP__/Show/show_ds_class?Id=<?php echo ($ds_class["Id"]); ?>"><?php echo ($ds_class["theme"]); ?></a>  
      <span><?php echo ($ds_class["datetime"]); ?></span>
      </li>
