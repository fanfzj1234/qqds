...
<div class="container">
   <a href="__APP__">首页</a>>>创业资讯列表
  <div id="info_list_main">
   <?php
 $count = count($bc_infos); if($count){ ?>
    <ul>
      <?php if(is_array($bc_infos)): foreach($bc_infos as $key=>$bc_info): ?><li><a href="__APP__/Show/show_bc_info?Id=<?php echo ($bc_info["Id"]); ?>"><?php echo ($bc_info["theme"]); ?></a>  
      <span><?php echo ($bc_info["publish_time"]); ?></span>
      </li>
