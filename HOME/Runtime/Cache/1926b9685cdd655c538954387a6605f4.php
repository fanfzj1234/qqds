  ...
  <div class="container">
    <div class="content">
      <div id="featured_slide">
        <ul id="featurednews">
          <li><img src="__IMG__/艺术设计学院.jpg" alt="" />
          ...
          <li><img src="__IMG__/齐大美景.jpg" alt="" />
            <div class="panel-overlay">
              <h2>齐大美景</h2>
              <p>                        <br />
                <a href="#">Continue Reading &raquo;</a></p>
          ...
          <li><img src="__IMG__/游泳馆.jpg" alt="" />
            <div class="panel-overlay">
              <h2>游泳馆</h2>
              <p>                        <br />
                <a href="#">Continue Reading &raquo;</a></p>
    ...
    <div class="column">
      <ul class="latestnews">
        ...
        <li><img src="http://placehold.it/100x100" alt="" /><?php $club_activity_arr[1]['photo'] ?>
         ...
         <li><img src="http://placehold.it/100x100" alt="" /><?php $club_activity_arr[2]['photo'] ?>
          <p><strong><a href="__APP__/Show/show_activity?Id=<?php echo$club_activity_arr[2]['Id']; ?>"><?php echo $club_activity_arr[0]['theme']; ?></a></strong> <?php echo substr($club_activity_arr[2]['demand'],0,100); ?></p>
        </li>
      </ul>
    </div>
    <br class="clear" />
...
<!-- ####################################################################################################### -->
  <div class="wrapper">
  <div id="adblock">
    <div class="fl_left"><a href="#"><img src="__IMG__/demo/1.jpg" alt="" /></a></div>
    <div class="fl_right"><a href="#"><img src="__IMG__/demo/2.jpg" alt="" /></a></div>
    <br class="clear" />
  </div>
  <div id="hpage_cats">
    <div class="fl_left">
...
<div class="wrapper">
  <div class="container">
    <div class="content">
      <div id="hpage_latest">
        ...
        <ul>
          ...
          <li><img src="__IMG__/茅侃侃.jpg" alt="" />
          ...
          <li class="last"><img src="__IMG__/戴志康.jpg" alt="" />
    ...
    <div class="column">
      <div class="holder"><a href="#"><img src="__IMG__/demo/电子商务.jpg" alt="" /></a></div>
