...
<div id="info_list_main">
   <?php
 $count = count($cy_projects); if($count){ ?>
    <ul>
      <?php if(is_array($cy_projects)): foreach($cy_projects as $key=>$cy_project): ?><li><a href="__APP__/Show/show_cy_project?Id=<?php echo ($cy_project["Id"]); ?>"><?php echo ($cy_project["theme"]); ?></a>  
      <span><?php echo ($cy_project["datetime"]); ?></span>
      </li>
